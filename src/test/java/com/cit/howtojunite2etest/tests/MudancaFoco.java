...
public class MudancaFoco {
    ...
    public void validarAberturaNovaAba () {
        ...
        list = this.navegador.getWindowHandles().stream().collect(Collectors.toList());

        this.navegador.switchTo().window(list.get(list.size() - 1).toString());

        String result = this.navegador.findElement(By.xpath("/html/body/div[2]/div[2]/div[2]/div/h5")).getText();
